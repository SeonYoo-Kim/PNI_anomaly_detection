...
python analysis_code/calc_ensemble_score.py --category background --backbone_list WR101 --project_root_path ./result --ensemble_root_path ./result/WR101_result
python analysis_code/calc_ensemble_score.py --category illumination --backbone_list WR101 --project_root_path ./result --ensemble_root_path ./result/WR101_result
python analysis_code/calc_ensemble_score.py --category same --backbone_list WR101 --project_root_path ./result --ensemble_root_path ./result/WR101_result
python analysis_code/calc_ensemble_score.py --category view --backbone_list WR101 --project_root_path ./result --ensemble_root_path ./result/WR101_result
...
python analysis_code/convert_result_format.py --before_result_root_dir ./result/WR101_result --after_result_root_dir ./result/WR101_ravel --is_AeBAD
...
python analysis_code/analysis_amap.py --project_root_path ./result/WR101_ravel --visualize --is_AeBAD